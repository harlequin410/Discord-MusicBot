module.exports = {
  ...
  Lavalink: {
    ...
    host: "lavalink.kapes.eu", //- The host name or IP of the lavalink server.
    port: 2222, // The port that lavalink is listening to. This must be a number!
    pass: "lavalinkplay", //- The password of the lavalink server.
